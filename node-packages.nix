...
let
  sources = {
    ...
    "gh-pages-3.1.0" = {
      ...
      version = "3.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/gh-pages/-/gh-pages-3.1.0.tgz";
        sha512 = "3b1rly9kuf3/dXsT8+ZxP0UhNLOo1CItj+3e31yUVcaph/yDsJ9RzD7JOw5o5zpBTJVQLlJAASNkUfepi9fe2w==";
      };
    };
    "gl-matrix-3.3.0" = {
      name = "gl-matrix";
